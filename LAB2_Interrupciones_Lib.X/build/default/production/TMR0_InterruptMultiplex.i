...
# 9 "TMR0_InterruptMultiplex.c" 2

# 1 "./TMR0_InterruptMultiplex.h" 1
# 13 "./TMR0_InterruptMultiplex.h"
...
# 13 "./TMR0_InterruptMultiplex.h" 2


void config_TMR0_InterruptMultiplex(uint8_t resultado_ADC_uni);
# 10 "TMR0_InterruptMultiplex.c" 2


void TMR0_InterruptMultiplex(uint8_t resultado_ADC_uni) {
    switch (resultado_ADC_uni){
        case 0:
            PORTC = 0b01111110;
            break;
        case 1:
